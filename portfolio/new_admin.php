...
// escape all strings for injection
$firstname = mysqli_real_escapei_string($con,$_POST['first_name']);
...
if ($password1 != $password2){header('Location: new_admin_page.php');}

// if username is more than 30 characters sent it back
if (strlen($firstname) > 30){header('Location: new_admin_page.php');}
...
if (preg_match($regex, $email))
{
    ...
    if(mysqli_num_rows($count) < 1)
    {
        ...
        // create the query
        $query = "INSERT INTO admin_tbl ( first_name, last_name, password, email, salt, activation ) VALUES
        ...
        $body .= "195.137.48.11/admin_activation.php?code=$activation";
